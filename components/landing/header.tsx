          ...
          <div className="flex flex-1 items-center justify-end gap-4">
            <div className="flex items-center gap-2">
              <Link
                href="/sign-in"
                className={cn(
                  "rounded-full border border-primary/30 bg-transparent px-5 py-2",
                )}
              >
                Login
              </Link>
              ...
              >
                Get Started
                <ChevronRight className="ml-1.5 size-4 text-primary" />
              </Link>
            </div>
